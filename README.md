...
<div style="background-color: #dbeafe; border: 3px solid #3b82f6; border-radius: 8px; padding: 20px; margin: 20px 0; box-shadow: 0 4px 6px rgba(59, 130, 246, 0.1); color: #000000;">

🚀 **BETA VERSION** 🚀

**This package is now in beta and ready for production evaluation. The API is stabilizing but minor changes may still occur.**
